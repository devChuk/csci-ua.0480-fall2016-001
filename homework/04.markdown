...
* set up handlebars - [check out these slides on templating](../slides/10/templating.html#/)
...
* in that route, generate a deck of cards, shuffle the deck, and get 5 cards from the shuffled deck
    ...
    * each card must have a __value__  (A, 2, 3, 4, 5, 6, 7, 8, 9, J, Q, K), and a suit (&hearts;, &diams;, &clubs;, &spades;)
...
* set up handlebars - [these slides](../slides/10/templating.html#/) may help
