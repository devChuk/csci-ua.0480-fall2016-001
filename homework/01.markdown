...
Note that the last command will make a modification to an existing file, `package.json`, within your project folder. You should commit the changes made to this file.

### (1 point) Install Required Modules

You'll need a module to help you ask the user for input. 
...
1. Find `enable1.txt` in your `src` folder - this is your word list
...
<pre><code data-trim contenteditable>var letterValues = { "E": 1, "A": 1, "I": 1, "O": 1, "N": 1, "R": 1, "T": 1, "L": 1, "S": 1, "U": 1, "D": 2, "G": 2, "B": 3, "C": 3, "M": 3, "P": 3, "F": 4, "H": 4, "V": 4, "W": 4, "Y": 4, "K": 5, "J": 8, "X": 8, "Q": 10, "Z": 10 };
</code></pre>
